...
/** Server-rendered landing — visible immediately (no JS opacity-0 flash). */
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-background">
      ...
      <main className="page-pad relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-14 pb-20 pt-8 md:gap-20 md:pt-16">
        <section className="flex flex-col items-center gap-6 text-center md:gap-8 animate-[fade-rise_0.55s_cubic-bezier(0.22,1,0.36,1)_both]">
        ...
        <section className="grid gap-6 md:grid-cols-3">
          {features.map((feature, index) => (
            <Card
              key={feature.title}
              className="glass-panel h-full border-border/50 transition-transform hover:-translate-y-1 animate-[fade-rise_0.6s_cubic-bezier(0.22,1,0.36,1)_both]"
        ...
        <Card className="glass-panel overflow-hidden border-border/50 animate-[fade-rise_0.65s_cubic-bezier(0.22,1,0.36,1)_both]" style={{ animationDelay: "280ms" }}>
